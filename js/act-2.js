addLayer("b", {
   ...
   milestones: {
                       51: {
                           ...
                           effectDescription: "gain 50% of lemon knowledge per second and keep all lemon farm milestones",
                           done () {
   ...
   cost: new Decimal(5000),
    ...
    44: {
   title: "Research White House",
   description: "Triple Research Point Gain",
...
addLayer("r", {
   ...
   passiveGeneration() {
       ...
       if (hasUpgrade('b', 43)) generation = generation.add(1)
       if (hasUpgrade('m', 37)) generation = generation.times(2)
       if (hasUpgrade('b', 44)) generation = generation.times(3)
       return generation
   },
   row: 2, // Row the layer is in on the tree (0 is the first row)
   ...
   layerShown() { return hasUpgrade('b', 43)},
   milestones: {
       ...
       upgrades: {
           ...
           64: {
               ...
               description: "Add a lemon knowledge subtab",

addLayer("ach", {
    ...
    achievements: {
        ...
        15: {
            name: "<h4 style='margin-top:5px'>Finally, $$$$</h4>",
        ...
        21: {
            name: "<h4 style='margin-top:5px'>Getting that business</h4>",
        ...
        22: {
            name: "<h4 style='margin-top:5px'>$$$$$$$$</h4>",
        ...
        23: {
            name: "<h4 style='margin-top:5px'>Farming^2</h4>",
        ...
        24: {
            name: "<h4 style='margin-top:5px'>Business^2</h4>",
        ...
        25: {
            name: "<h4 style='margin-top:5px'>Finally, Lemons</h4>",
    ...
    tabFormat: [
        ...
        "blank",
        ["display-text", function() { return " Set 1<br> <h1 style='color: #FFF29E' >Lemon Small Business</h1>"}],
        "blank",
        ...
        "blank",
        "blank",
        ["display-text", function() { return " Set 2<br>" + (hasAchievement('ach',26)?" <h1 style='color: #FFF29E' >Lemon Corporation</h1>": "<h1 style='color: #FFF29E' >????? ???????????</h1>")}],
        "blank",
        ...
        "blank",
        "blank",
        ["display-text", function() { return " Set 3<br>" + (hasAchievement('ach',46)?" <h1 style='color: #FFF29E' >Lemon Planet</h1>": "<h1 style='color: #FFF29E' >????? ??????</h1>")}],
        "blank",
